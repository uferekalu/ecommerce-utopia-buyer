        ...
        <div className="container col-10 auto">
            <div className="row auto mb-5">
                <Link href="/account/profile mr-5">
                    <a>
                        <h5 className="order-caption">Your Account </h5>
                    </a>
                </Link>
                <Link href="/account/orders">
                    <a>
                        <h5 className="order-caption">&#8227; Your Orders </h5>
                    </a>
                </Link>
            </div>
            ...
            <div className="row orders-headers">
                <ul>
                    ...
                    <li>
                        <Link href="/account/order-buy-again">
                            <a>Buy Again</a>
                        </Link>
                    </li>
                    <li>
                    ...
                    <li>
                        <Link href="/account/digital-orders">
                            <a>Digital Orders</a>
                        </Link>
                    </li>
                    <li>
                        <Link href="/account/local-store-orders">
                            <a>Local Store Orders</a>
                        </Link>
                    </li>
                    <li>
                        <Link href="/account/cancelled-orders">
                            <a>Cancel Orders</a>
                        </Link>
                    </li>
                </ul>
