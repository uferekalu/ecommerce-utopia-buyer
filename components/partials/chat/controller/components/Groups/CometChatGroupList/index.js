...
class CometChatGroupList extends React.PureComponent {
    ...
    render() {
        ...
        let createGroupBtn = (
            <div title={Translator.translate('CREATE_GROUP', this.state.lang)}>
        ...
        const groupListTemplate = (
            <React.Fragment>
                <div
                    css={groupWrapperStyle(this.props, theme)}
                    className="groups">
                    <div
                        css={groupHeaderStyle(theme)}
