...
class CometChatMessageComposer extends React.PureComponent {
    ...
    sendMediaMessage = (messageInput, messageType) => {
        ...
        SoundManager.play(
            enums.CONSTANTS.AUDIO['OUTGOING_MESSAGE'],
            this.context
        );
    ...
    render() {
        ...
        if (
            enums.CONSTANTS['LIVE_REACTIONS'].hasOwnProperty(
                this.props.reaction
            )
        ) {
        ...
        let docs = (
            <label
                title={docText}
                className="filelist__item item__file ml-30"
                id="file">
                <FolderOpenOutlined
                    onClick={() => {
        ...
        let avp = (
            <React.Fragment>
                <label
                    title={videoText}
                    className="filelist__item item__video ml-30 "
                    id="video">
                    <FolderAddOutlined
                        onClick={() => {
                ...
                <label
                    title={audioText}
                    className="filelist__item item__audio ml-30"
                    id="audio">
                    <AudioOutlined
                        onClick={() => {
                ...
                <label
                    title={imageText}
                    className="filelist__item item__image ml-30"
                    id="image">
                    <CameraOutlined
                        onClick={() => {
        ...
        let collaborativeDocBtn = (
            <div
                ...
                <button onClick={this.toggleCollaborativeDocument}>
                    collo w document
                </button>
            </div>
        );
        ...
        let collaborativeBoardBtn = (
            <div
                ...
                <button onClick={this.toggleCollaborativeBoard}>
                    collo withboard
                </button>
            </div>
        );
        ...
        let stickerBtn = (
            <div
                ...
                <button onClick={this.toggleStickerPicker}>Sticker</button>
            </div>
        );
                ...
                <div css={editPreviewContainerStyle(this.context, keyframes)}>
                    <div css={previewHeadingStyle()}>
                        ...
                        <span
                            ...
                            onClick={this.closeEditPreview}></span>
                    </div>
                    <div>{messageText}</div>
                </div>
            );
        ...
        if (this.state.emojiViewer) {
            emojiViewer = (
                <CometChatEmojiKeyboard emojiClicked={this.emojiClicked} />
            );
        }
