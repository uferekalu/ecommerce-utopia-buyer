    ...
    onTypingStarted = (item) => {
        const showTyping = (typingText) => {
            ...
            if (
                ...
                item.metadata.type ===
                    enums.CONSTANTS['METADATA_TYPE_LIVEREACTION']
            ) {
                this.props.actionGenerated(
                    enums.ACTIONS['SHOW_LIVE_REACTION'],
                    item
                );
            } else {
    ...
    onTypingEnded = (item) => {
        const endTyping = () => {
            ...
            if (
                ...
                this.props.actionGenerated(
                    enums.ACTIONS['STOP_LIVE_REACTION'],
                    item
                );
            } else {
                if (this.state.enableTypingIndicator === true) {
        ...
        this.context.FeatureRestriction.isOneOnOneAudioCallEnabled()
            .then((response) => {
                ...
                const combinedResponse =
                    response && !this.context.item.blockedByMe;
    ...
    render() {
        ...
        let audioCallBtn = (
            <div
                ...
                title={audioCallText}>
                <PhoneOutlined onClick={this.initiateAudioCall} />
            </div>
        );
        ...
        let videoCallBtn = (
            <div
                ...
                title={videoCallText}>
                <WhatsAppOutlined onClick={this.initiateVideoCall} />
            </div>
        );
        ...
        let viewDetailBtn = (
            <div
                ...
                <AlignRightOutlined onClick={this.viewDetail} />
            </div>
        );
        ...
        return (
            <div css={chatHeaderStyle(this.context)} className="chat__header">
                <div css={chatDetailStyle()} className="chat__details">
                    <div
                        css={chatSideBarBtnStyle(
                            menuIcon,
                            this.props,
                            this.context
                        )}
                        className="chat__sidebar-menu"
                        onClick={this.resetChat}></div>
