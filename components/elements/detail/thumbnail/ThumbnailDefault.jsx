...
const ThumbnailDefault = ({ product, vertical = true }) => {
    ...
    useEffect(() => {
        ...
        if (product.url) {
            let images = [product.url];
            setProductImages(images);
        } else {
            setProductImages([
                'https://lh3.googleusercontent.com/proxy/QQdRiGWVczwzay5-Xn2nJwsLyEVwaYgqqN4aGL4GlgjMW6336l--E5XvbLkPihgwAyNnMFkQyTD0tJuiKRaleax-SUqFYMNGdb4dDMXoM0qPSMzVRsTjW0SBuvwu2nNbgFOibUdA3i6xBg',
            ]);
        }
