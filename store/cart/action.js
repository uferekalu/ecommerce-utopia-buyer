export const actionTypes = {
    ...
    UPDATE_SHIPPING_COST_SUCCESS: 'UPDATE_SHIPPING_COST_SUCCESS',

    ADD_ITEMS_SHIPPING_CART: 'ADD_ITEMS_SHIPPING_CART',
};
...
export function updateShippingCost(country) {
    return { type: actionTypes.UPDATE_SHIPPING_COST, country};
}

export function updateShippingCostSuccess(payload) {
    return { type: actionTypes.UPDATE_SHIPPING_COST_SUCCESS , payload};
}

export function addItemsShippingCart(payload) {
    return {
        type: actionTypes.ADD_ITEMS_SHIPPING_CART,
        payload,
    };
}
